...
export const MODEL_CONFIGS: Record<PieceColor, Record<PieceType, PieceModelConfig>> = {
  ...
  villain: {
    ...
    // Tripo-generated (AI image-to-3D) replacement for the procedural pawn — front already faces
    // the board center unrotated, like the villain king from the same generation batch.
    pawn: { path: '/models/villain_pawn.glb', scale: 1.05, rotation: [0, 0, 0] },
  },
};
